...
## **Introduction**
Flor yeasts are specialized strains of Saccharomyces cerevisiae that form a floating biofilm, known as velum, during biological wine aging. Formation of this biofilm enables yeast cells to survive under limited nutrient and oxidative conditions by shifting from fermentative metabolism toward respiratory metabolism. This metabolic transition requires extensive transcriptional reprogramming that influences energy metabolism, stress responses, membrane composition, and cellular remodelling.
...
Raw sequencing reads were quality assessed using FastQC and summarized with MultiQC. Transcript abundances were quantified against the S. cerevisiae reference transcriptome using Salmon. Transcript-level quantifications generated by Salmon were imported using the tximport package (Soneson et al., 2015) to generate a DESeqDataSet with three experimental groups: early, thin and mature. 
...
Significantly expressed genes (padj < 0.05) were used for Over-Representation Analysis (ORA) and Gene Set Enrichment Analysis (GSEA), in which genes were ranked, and both analyses used Benjamini–Hochberg correction. Gene Ontology annotations were obtained from the Bioconductor organism database org.Sc.sgd.db.
